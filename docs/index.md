...
## خاتمه
من [bistcuite]() هستم، امیدوارم که این پکیج بدردتون خورده باشه، می‌تونید برای حمایت از پروژه، به [مخزن کتابخانه در گیت‌هاب](https://github.com/bistcuite/eitaapykit) ستاره بدهید و چه بهتر که با ارسال pull request به ما در بهتر شدن این پکیج کمک کنید.